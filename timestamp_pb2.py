...
_TIMESTAMP = _descriptor.Descriptor(
  name='Timestamp',
  full_name='Seefar.Interfaces.Timestamp',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='seconds', full_name='Seefar.Interfaces.Timestamp.seconds', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='nanos', full_name='Seefar.Interfaces.Timestamp.nanos', index=1,
...
Timestamp = _reflection.GeneratedProtocolMessageType('Timestamp', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:Seefar.Interfaces.Timestamp)
  })
